		...
		accountChainTable := []struct {
		...
		}{
			{
				...
				func(rpcURL pack.String) (multichain.AccountClient, multichain.AccountTxBuilder) {
					client, err := ethereum.NewClient(string(rpcURL), big.NewInt(1))
					Expect(err).NotTo(HaveOccurred())
			...
			},
			{
				...
				func(rpcURL pack.String) (multichain.AccountClient, multichain.AccountTxBuilder) {
					client, err := polygon.NewClient(string(rpcURL), big.NewInt(1))
					Expect(err).NotTo(HaveOccurred())
			...
			},
			{
				...
				func(rpcURL pack.String) (multichain.AccountClient, multichain.AccountTxBuilder) {
					client, err := bsc.NewClient(string(rpcURL), big.NewInt(1))
					Expect(err).NotTo(HaveOccurred())
			...
			},
			{
				...
				func(rpcURL pack.String) (multichain.AccountClient, multichain.AccountTxBuilder) {
					client, err := avalanche.NewClient(string(rpcURL), big.NewInt(1))
					Expect(err).NotTo(HaveOccurred())
			...
			},
			{
				...
				func(rpcURL pack.String) (multichain.AccountClient, multichain.AccountTxBuilder) {
					client, err := fantom.NewClient(string(rpcURL), big.NewInt(1))
					Expect(err).NotTo(HaveOccurred())
