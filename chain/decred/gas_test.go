...
var _ = Describe("Gas", func() {
	Context("when estimating decred network fee", func() {
		It("should work", func() {
			...
			gasEstimator1 := decred.NewGasEstimator(client, 1, pack.NewU256FromUint64(fallback1))
			...
			gasEstimator2 := decred.NewGasEstimator(client, 10, pack.NewU256FromUint64(fallback2))
			...
			gasEstimator3 := decred.NewGasEstimator(client, 100, pack.NewU256FromUint64(fallback3))
